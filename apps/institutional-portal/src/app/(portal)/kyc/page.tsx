...
const STATUS_DESC: Record<string, string> = {
  ...
  UNDER_REVIEW:
    "Documents under review. We will notify you within 2–3 business days.",
  APPROVED: "Your institution is verified. Full trading access is active.",
  REJECTED:
    "Verification rejected. Please resubmit with the correct documentation.",
      ...
      <div className="max-w-xl space-y-5">
          ...
          <div>
            ...
            {kycStatus?.updatedAt && (
              <p className="text-xs text-gray-400 mt-1">
                Updated: {formatDate(kycStatus.updatedAt)}
              </p>
            )}
          </div>
        </div>
              ...
              {isLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-400 text-center">
                    Powered by Sumsub. All documents are encrypted and stored
                    securely.
                  </p>
                </div>
              )}
        ...
        {status === "APPROVED" && (
          <div className="rounded-xl border border-green-200 dark:border-green-700 bg-green-50 dark:bg-green-900/20 p-4 text-sm text-green-800 dark:text-green-300">
            Your institution is fully verified. You have unrestricted access to
            buy, hold, sell, and redeem gold tokens.
          </div>
        )}
      </div>
    </div>
