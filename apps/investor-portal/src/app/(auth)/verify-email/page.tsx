...
export default function VerifyEmailPage() {
  return (
    <Suspense fallback={<Card><CardContent className="py-10 text-center"><Loader2 className="h-10 w-10 text-gold-500 animate-spin mx-auto" /></CardContent></Card>}>
      <VerifyEmail />
    </Suspense>
  );
}
      ...
      <CardContent className="py-10 text-center space-y-4">
        ...
        {status === 'error' && (
          <>
            ...
            <Link href="/register" className="text-sm text-gold-600 hover:underline">
              Register again
            </Link>
          </>
        )}
