...
const STATUS_DESC: Record<string, string> = {
  ...
  UNDER_REVIEW: 'Your documents are being reviewed. This usually takes 1–2 business days.',
  ...
  NEEDS_REVIEW: 'Additional information is required. Please click below to resubmit.',
};
...
export default function KycPage() {
  ...
  const submitMutation = useMutation({
    ...
    onError: (e) => setError(e instanceof ApiError ? e.message : 'KYC submission failed'),
  });
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      <h1 className="text-lg font-bold text-gray-900 dark:text-gray-100">Identity Verification</h1>
      ...
      <div className="max-w-2xl space-y-6">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle>
                  {status === 'PENDING' ? 'Start Verification' : 'Resubmit Verification'}
                </CardTitle>
                {widgetOpen && sdkToken && (
                  <button
              ...
              {isLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-400 text-center">
                    Powered by Sumsub — your documents are encrypted and handled securely.
                  </p>
                </div>
              )}
            </CardContent>
        ...
        {status === 'APPROVED' && (
          <Alert variant="success" title="Fully verified">
            Your identity has been verified. You have full access to buy, hold, and sell gold tokens.
          </Alert>
        )}
