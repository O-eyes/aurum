      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-md p-6 space-y-4">
        <div className="flex items-start gap-4">
          <div className={cn(
            ...
            variant === 'danger' ? 'bg-red-100 dark:bg-red-900/30' : 'bg-gold-100 dark:bg-gold-900/30',
          )}>
            <AlertTriangle className={cn(
              'h-5 w-5',
              variant === 'danger' ? 'text-red-600 dark:text-red-400' : 'text-gold-600 dark:text-gold-400',
            )} />
          </div>
          <div>
