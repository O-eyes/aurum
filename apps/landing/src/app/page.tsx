    ...
    >
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <span
            className={`font-bold text-lg tracking-tight ${scrolled || open ? "text-gray-900" : "text-white"}`}
          >
            {TENANT.name}
          </span>
        </Link>
        ...
        >
          {open ? (
            ...
            <Menu
              className={`h-5 w-5 ${scrolled ? "text-gray-900" : "text-white"}`}
            />
          )}
        </button>
      </nav>
    ...
    <section className="relative min-h-screen bg-gray-950 flex flex-col items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        <p className="mt-7 text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
          ...
          <span className="text-white font-medium">{minLabel}</span>, backed by
          vault holdings at {TENANT.custodian.name} and verifiable on-chain. Pay
          with Mobile Money or card.
        </p>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center mb-18">
          ...
          <p className="mt-5 text-lg text-gray-500 max-w-xl mx-auto">
            Own gold in three steps — no broker, no minimum bar, no storage
            headache.
          </p>
        </div>
...
function LiveReserve() {
  ...
  const goldValueUsd =
    snapshot && goldOz ? goldOz * parseFloat(snapshot.goldPriceUsd) : null;
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-5 text-gray-400 max-w-lg mx-auto text-lg">
            Our reserve is publicly verifiable on-chain and audited by third
            parties. Here's the live status, updated every minute.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <p className="text-center text-gray-600 py-16 text-sm">
            Reserve data temporarily unavailable
          </p>
        )}
      </div>
    </section>
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-12 rounded-2xl bg-white border border-gray-100 shadow-sm overflow-hidden">
          <div className="grid grid-cols-3 text-sm">
            ...
            <div className="px-6 py-4 text-center font-semibold text-gray-900 border-l border-gray-100">
              Physical gold
            </div>
          ...
          {[
            ...
            >
              ...
              <div className="px-6 py-3.5 text-center text-gray-600 border-l border-gray-100">
                {trad}
              </div>
              <div className="px-6 py-3.5 text-center font-medium text-gold-700 border-l border-gold-100 bg-gold-50/50">
                {aur}
              </div>
            </div>
          ))}
...
function SecurityCustody() {
  const pillars = [
    ...
    },
    {
      ...
      description: `Vault holdings are kept under ${TENANT.custodian.name}'s professional custody, subject to their security and insurance controls.`,
    },
    {
    ...
    },
    {
      ...
      description: `New ${TENANT.ticker} tokens can only be minted against verified gold reserves. The token contract is open for independent security audit ahead of mainnet launch.`,
    },
  ];
    ...
    <section className="py-28 bg-white">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-sm font-semibold text-gold-600 uppercase tracking-widest mb-4">
              Security & Custody
            </p>
            ...
            <p className="mt-6 text-lg text-gray-500 leading-relaxed">
              ...
              <span className="font-medium text-gray-900">
                {TENANT.custodian.name}
              </span>
              , a licensed gold custodian in {TENANT.custodian.jurisdiction}.
              Your gold is held in your name — if {TENANT.name} ceased to exist,
              you could redeem directly from the custodian.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {pillars.map((p) => (
              <div
                key={p.title}
                className="rounded-2xl border border-gray-100 bg-gray-50 p-5 hover:shadow-sm transition-shadow"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-gray-600 leading-relaxed">
              {TENANT.name} provides institutional-grade gold exposure — OTC
              pricing, full API integration, and a dedicated relationship
              manager to support your compliance team.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {features.map((f) => (
              <div
                key={f}
                className="flex items-start gap-3 rounded-xl bg-white shadow-sm border border-gold-100 p-4"
              >
    ...
    <section className="py-24 bg-gray-950">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mt-5 text-lg text-gray-400">
          Join thousands of Ghanaians protecting their wealth with real gold —
          from {minLabel}.
        </p>
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid grid-cols-2 gap-10 md:grid-cols-4 mb-14">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="mt-5 flex items-center gap-1.5 text-xs text-gray-600">
              ...
              Custodian: {TENANT.custodian.name},{" "}
              {TENANT.custodian.jurisdiction}
            </div>
          </div>
        ...
        <div className="border-t border-gray-800/80 pt-8 flex flex-col sm:flex-row justify-between gap-4 text-xs text-gray-600">
          ...
          <p className="sm:max-w-md sm:text-right leading-relaxed">
            {TENANT.ticker} tokens are backed by physical gold held by{" "}
            {TENANT.custodian.name}. Investing in digital assets carries risk.
