...
export const TENANT = {
  ...
  investorPortalUrl: process.env.NEXT_PUBLIC_INVESTOR_URL ?? 'http://localhost:3001',
  institutionalPortalUrl: process.env.NEXT_PUBLIC_INSTITUTIONAL_URL ?? 'http://localhost:3002',
