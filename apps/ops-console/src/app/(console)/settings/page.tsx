    ...
    <div className="p-4 sm:p-6 space-y-6 max-w-2xl">
      ...
      <div className="bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-700 shadow-sm">
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <p className="text-xs text-gray-500">Profile details are managed by the system administrator.</p>
        </div>
      </div>
      ...
      <div className="bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-700 shadow-sm">
        <div className="px-6 py-4 border-b border-gray-700">
          <h2 className="text-sm font-semibold text-gray-200">Roles &amp; Permissions</h2>
        </div>
          ...
          {user?.roles?.map((role) => {
            ...
            return (
              ...
              >
                ...
                {meta && (
                  <span className={`text-xs rounded-full px-2 py-0.5 ${meta.color}`}>{meta.label}</span>
                )}
              </div>
            );
          })}
          <p className="text-xs text-gray-500">Role changes require an administrator.</p>
        </div>
      </div>
      ...
      <div className="bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-700 shadow-sm">
        ...
        >
          ...
          <Field label="New password" error={errors.newPassword?.message} hint="Minimum 8 characters">
            <input
              type="password"
              className="w-full rounded-lg border border-gray-600 bg-gray-900 px-3 py-2 text-sm text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-500"
