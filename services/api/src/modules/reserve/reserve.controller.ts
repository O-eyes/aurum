...
import { ManualSnapshotSchema, type ManualSnapshotDto } from './dto/reserve-snapshot.dto';
...
export class ReserveController {
  ...
  @Public()
  @Get('snapshot/public')
  @ApiOperation({ summary: '[Public] Latest reserve snapshot — for investor portals and landing page' })
